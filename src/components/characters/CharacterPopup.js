...
export function CharacterPopup() {
  ...
  const { data, handleInputChange, handleSubmit } = useForm(saveCharacter, { ...EMPTY_CHARACTER, owner: firebase.user(userid) });
      ...
      <Modal.Content image>
        ...
        <Modal.Description style={{ width: '100%' }}>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Input fluid icon='user' iconPosition='left' label={language.translate('labelCharName', 'Character name')}
